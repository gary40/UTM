...
async def main():
    async with async_playwright() as p:
        ...
        rec('E 分享', 'E1 「分享挑戰！」開平台面板：兩平台＋系統分享，Threads／FB 連結帶 share_id', sheet['shown'] and sheet['label']=='分享挑戰！' and sheet['pfs']==['Threads','Facebook','系統分享'] and sheet['th'].startswith('https://www.threads.net/intent/post?text=') and '%26s%3D' in sheet['th'] and sheet['fb'].startswith('https://www.facebook.com/sharer/sharer.php?u=') and '%26p%3Dfacebook' in sheet['fb'], str(sheet['pfs']))
